...
export async function POST(req: NextRequest) {
  try {
    ...
    const PRACTICE_EXAMS: Record<string, { bank: ExamLevel; accessDoc: string; label: string }> = {
      ...
      practice_jr_hvac_tech: { bank: 'jr_hvac_tech', accessDoc: 'practice_jr_hvac_tech', label: 'Jr. HVAC Tech' },
      ...
      practice_jr_bmet_tech: { bank: 'jr_bmet_tech', accessDoc: 'practice_jr_bmet_tech', label: 'Jr. BMET Tech' },
    ...
    if (!['jr_fse', 'fse', 'jr_kitchen_fse', 'jr_hvac_fse', 'jr_gen_fse', 'jr_dc_cft', 'jr_solar_fse', 'jr_ev_tech', 'jr_dcp_tech', 'jr_battery_tech', 'jr_dc_engineer', 'jr_marine_tech', 'jr_pool_tech', 'jr_hvac_tech', 'jr_solar_inst', 'jr_wind_tech', 'jr_elevator_tech', 'jr_fire_alarm_tech', 'jr_bmet_tech', 'jr_bas_tech', 'jr_ref_tech'].includes(examLevel)) {
    ...
    const JR_COURSE_EXAMS: Record<string, { label: string; productId: string; courseKey: string }> = {
      ...
      jr_hvac_tech: { label: 'Jr. HVAC Tech', productId: 'jr_hvac_tech_test_human', courseKey: 'training_hvac_tech' },
      ...
      jr_bmet_tech: { label: 'Jr. BMET Tech', productId: 'jr_bmet_tech_test_human', courseKey: 'training_bmet_tech' },
