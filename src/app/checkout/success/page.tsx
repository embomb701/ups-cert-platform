...
const PRODUCT_INFO: Record<string, ProductInfo> = {
  ...
  // ── Test-out packages (training + test-out bundles) ────────────────────
  ...
  pkg_training_dcengineer_testout:    { heading: 'DC Engineer Bundle Activated', detail: 'Training and exam access for Data Center Engineer are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_marine_testout:        { heading: 'Marine Tech Bundle Activated', detail: 'Training and exam access for Marine Systems Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_pool_testout:          { heading: 'Pool Tech Bundle Activated', detail: 'Training and exam access for Pool Equipment Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_hvac_tech_testout:     { heading: 'HVAC Tech Bundle Activated', detail: 'Training and exam access for HVAC Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_solar_inst_testout:    { heading: 'Solar Installer Bundle Activated', detail: 'Training and exam access for Solar Installer are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_wind_tech_testout:     { heading: 'Wind Tech Bundle Activated', detail: 'Training and exam access for Wind Turbine Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_elevator_tech_testout: { heading: 'Elevator Tech Bundle Activated', detail: 'Training and exam access for Elevator Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_fire_alarm_tech_testout: { heading: 'Fire Alarm Tech Bundle Activated', detail: 'Training and exam access for Fire Alarm Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_bmet_tech_testout:     { heading: 'BMET Bundle Activated', detail: 'Training and exam access for Biomedical Equipment Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_bas_tech_testout:      { heading: 'BAS Tech Bundle Activated', detail: 'Training and exam access for Building Automation Systems Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_ref_tech_testout:      { heading: 'Ref Tech Bundle Activated', detail: 'Training and exam access for Commercial Refrigeration Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_plc_tech_testout:      { heading: 'PLC Tech Bundle Activated', detail: 'Training and exam access for Industrial Controls & PLC Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_security_tech_testout: { heading: 'Security Tech Bundle Activated', detail: 'Training and exam access for Electronic Security Systems Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_field_pm_testout:      { heading: 'Field PM Bundle Activated', detail: 'Training and exam access for Field Project Manager are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
  pkg_training_pump_tech_testout:     { heading: 'Pump Tech Bundle Activated', detail: 'Training and exam access for Pump Technician are both unlocked.', nextStep: { label: 'Start Training →', href: '/training' } },
