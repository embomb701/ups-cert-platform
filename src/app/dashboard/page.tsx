            ...
            <div className="space-y-2">
              {attempts.map(a => (
                <div key={a.id} className="flex items-center justify-between text-sm py-2 border-b border-gray-800 last:border-0">
                  <span className="text-gray-400">{a.examLevel === 'jr_fse' ? 'Jr. FSE' : a.examLevel === 'jr_kitchen_fse' ? 'Jr. Kitchen FSE' : a.examLevel === 'jr_hvac_fse' ? 'Jr. HVAC FSE' : a.examLevel === 'jr_gen_fse' ? 'Jr. Generator FSE' : a.examLevel === 'jr_dc_cft' ? 'Jr. Data Center CFT' : a.examLevel === 'jr_solar_fse' ? 'Jr. Solar FSE' : a.examLevel === 'jr_ev_tech' ? 'Jr. EV Tech' : a.examLevel === 'jr_dcp_tech' ? 'Jr. DC Plants Tech' : a.examLevel === 'jr_battery_tech' ? 'Jr. Battery Tech' : a.examLevel === 'jr_dc_engineer' ? 'Jr. DC Engineer' : a.examLevel === 'jr_marine_tech' ? 'Jr. Marine Tech' : a.examLevel === 'jr_pool_tech' ? 'Jr. Pool Tech' : a.examLevel === 'fse_ai' ? 'FSE AI' : 'FSE'}</span>
