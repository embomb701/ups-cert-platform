  ...
  return (
    <section className="section-pad">
      <div className="container-site max-w-5xl mx-auto space-y-8">
        ...
        {/* Welcome / onboarding — only for brand-new accounts with zero progress */}
        {!dataLoading && data && courses.length === 0 && (
          <div className="card-dark p-6 border-indigo-800/50 bg-indigo-950/10">
            <p className="text-xs font-semibold text-indigo-400 uppercase tracking-widest mb-2">Welcome</p>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/course-finder"
                className="px-4 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition-colors"
              >
                Take the Course Finder →
              </Link>
              <Link
                href="/courses"
            ...
            >
              Or just for fun — find your Field Service Archetype →
            </Link>
          </div>
        )}
