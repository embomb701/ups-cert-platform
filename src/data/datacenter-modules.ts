    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/dc-room-cooling.svg', alt: 'Data center room cooling diagram showing a CRAC/CRAH unit, raised floor plenum, perforated tiles feeding a cold aisle, racks, and a hot aisle return, with bypass and recirculation labeled as the twin airflow sins', caption: 'The room is an airflow circuit — bypass and recirculation are the twin sins' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/dc-containment-pue.svg', alt: 'Cold aisle containment diagram with an audit checklist for blanking panels and door seals, the ASHRAE TC 9.9 recommended inlet envelope, the PUE formula, and a callout about cooling on generator during transfer', caption: 'Containment and warmer setpoints save energy but shrink thermal ride-through' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/dc-liquid-cooling-ladder.svg', alt: 'Liquid cooling ladder diagram comparing rear-door heat exchangers, direct-to-chip cooling with a Coolant Distribution Unit, and immersion cooling, with rack density context and CDU service details', caption: 'Air cannot carry AI heat — the industry moved liquid to the chips' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/dc-three-stacks.svg', alt: 'Diagram of the three data center monitoring stacks: EPMS for the electrical power chain, BMS for the mechanical plant, and DCIM for capacity and assets above both, with sensor truth verification and the read-verify-feed working relationship', caption: 'EPMS, BMS, DCIM — three overlapping systems the tech lives in' },
        ],
        keyPoints: [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/dc-redundancy-levels.svg', alt: 'Redundancy vocabulary diagram comparing N, N+1, and 2N configurations, concurrent maintainability, A and B path independence with an extension-cord violation example, and rounds and incident response discipline', caption: 'N / N+1 / 2N decides what you may touch, and when' },
        ],
        keyPoints: [
