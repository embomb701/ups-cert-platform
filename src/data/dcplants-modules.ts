    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/dcplant-always-on-architecture.svg', alt: 'Diagram of the parallel-redundant float architecture with rectifiers, the -48V bus, batteries, and load, alongside the negative-ground corrosion explanation and a voltage reference table for float, equalize, end of discharge, and emergency cutoff', caption: 'The battery IS the bus — no transfer switch, no interruption' },
        ],
        tables: [
          {
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/rectifier-shelf-hotswap.svg', alt: 'Rectifier shelf diagram showing eight hot-swappable modules on a shared OR-ing bus bar with two in fault, alongside sick-brick diagnosis, temperature compensation coefficients, and PM and alarm threshold guidance', caption: 'Hot-swap bricks are live-bus work — read the shelf display before touching anything' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/dc-distribution-livebus.svg', alt: 'DC distribution hierarchy diagram from rectifier bus through MBDFB and BDFB to equipment frame, with five live-bus safety rules and blown fuse diagnosis guidance', caption: 'The bus is always energized — isolate at the fuse, never assume it is dead' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/lvd-millivolt-hunt.svg', alt: 'Low-voltage disconnect diagram showing critical loads staying up and non-critical loads shedding at the LVD threshold, alongside the millivolt-drop hunt test method and battery string balance guidance', caption: 'LVD sheds non-critical loads to preserve runtime — investigate why it operated' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/cell-site-genset-safety.svg', alt: 'Cell site diagram showing the three power domains of shelter power, tower loads, and environmental systems, plus reserve time SLA discipline and portable genset connection safety requiring the utility disconnect to open before the generator connects', caption: 'Utility disconnect open first — a backfeeding genset can kill a line crew' },
        ],
        keyPoints: [
