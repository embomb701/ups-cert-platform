    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/ev-charging-levels-connectors.svg', alt: 'Diagram comparing Level 1, Level 2, and DCFC charging power levels alongside the J1772, CCS, NACS, and CHAdeMO connector types', caption: 'Three power levels, four connectors — know the inlet and the adapter story before you dispatch.' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/j1772-pilot-states.svg', alt: 'Diagram of the J1772 control pilot states A through F, the duty cycle current encoding, and how DCFC uses ISO 15118 or CHAdeMO CAN for a separate communication layer', caption: 'The control pilot handshake — State B to State C is the transition every "connects but won\'t charge" call comes down to.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/dcfc-modular-architecture.svg', alt: 'Diagram of the DCFC power chain from three-phase AC input through the rectifier, DC bus, and isolated DC-DC output, plus panels on the modular sick-brick pattern and liquid cooling requirements', caption: 'The UPS power chain aimed at a vehicle — modular power bricks mean one sick module derates output, it doesn\'t kill the charger.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/ev-site-power-demand-charges.svg', alt: 'Diagram of the EV charging site one-line from utility transformer through main disconnect and distribution to charger branch circuits, plus a demand charge cost example and typical site sizing table', caption: 'The one-line and the bill — demand charges from an eight-vehicle simultaneous session can add $12,000-$30,000 to a monthly bill.' },
        ],
        tables: [
          {
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/ev-dead-charger-diagnostic-tree.svg', alt: 'Diagram of the four initial charger findings, the completely-dead remote-first check, the won\'t-start authorization/handshake/power-initiation cascade, and the four OCPP StopTransaction termination reasons', caption: 'Four findings, one rule: read the OCPP logs before you roll a truck — the reason code is 80% of the diagnosis.' },
        ],
        keyPoints: [
