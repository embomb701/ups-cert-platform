    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/cranking-circuit.svg', alt: 'Cranking circuit diagram showing battery, starter solenoid, and starter motor with the ground return path, voltage drop under crank test values, and a symptom to measurement table for crank complaints', caption: 'Test under crank, not at rest — resistance hides until current flows' },
        ],
        tables: [
          {
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/diesel-four-stroke.svg', alt: 'Four-stroke diesel compression ignition cycle showing intake, compression, power, and exhaust strokes with no spark plug, alongside the three things diesel needs to run and turbocharger cooldown discipline', caption: 'Compression heat is the ignition source — no spark plug anywhere' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/diesel-fuel-path.svg', alt: 'Diesel fuel path diagram from main tank through transfer pump, day tank, filter and water separator, lift pump, secondary filters, injection, and return line, with common rail pressure warning and suction-side air leak diagnostic', caption: 'Main tank to cylinder — and where air sneaks in undetected' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/alternator-avr.svg', alt: 'Alternator excitation chain diagram showing PMG pilot, AVR, exciter, rotating rectifier, and main field, alongside rotor and stator anatomy, under-frequency roll-off explanation, and a no-voltage troubleshooting short list', caption: 'Field current sets voltage, RPM sets frequency — the two-knob model' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/ats-transfer-sequence.svg', alt: 'Eight-step automatic transfer switch sequence from utility failure through start delay, generator start, ATS watching the generator, transfer, retransfer delay, retransfer, and cooldown, plus a comparison of open, delayed, and closed transition types', caption: 'The decision-maker of standby power — every timer exists for a reason' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/generator-paralleling-sync.svg', alt: 'Generator paralleling diagram showing the three synchronization requirements of voltage, frequency, and phase angle before breaker closure, plus the division of labor on a shared bus between governor kW share and AVR kVAR share', caption: 'Sync before closure — the trade\'s most violent mistake is skipping it' },
        ],
        keyPoints: [
