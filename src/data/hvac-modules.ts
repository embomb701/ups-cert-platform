  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/psychrometric-sensible-latent.svg', alt: 'Diagram showing sensible cooling as a horizontal temperature move, latent cooling as a vertical moisture move, and the real coil path moving down and left, with the ASHRAE comfort zone and diagnostic notes about missing condensate', caption: 'Sensible vs. latent — the coil does both, and the split matters' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/split-system-anatomy.svg', alt: 'Split HVAC system diagram showing the indoor section with evaporator coil and condensate system, the outdoor unit with condenser fan and dual run capacitor, and the line set with suction and liquid lines connecting them', caption: 'Two boxes, one refrigeration circuit — the line set is a component, not just plumbing' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/heat-pump-reversing-valve.svg', alt: 'Heat pump reversing valve diagram comparing cooling mode where the indoor coil is the evaporator and heating mode where the outdoor coil is the evaporator, with defrost cycle and auxiliary heat explanations', caption: 'Same four parts — one valve swaps which coil evaporates and which condenses' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/rtu-anatomy.svg', alt: 'Rooftop unit cross section showing the condenser section, evaporator coil and blower, gas heat section, filters and outdoor air hood, and control panel sitting on a roof curb with supply and return ducts, alongside staged capacity and roof safety notes', caption: 'The entire system on a curb — most light-commercial buildings run on these' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/furnace-sequence.svg', alt: 'Eight-step gas furnace sequence of operation from thermostat call through inducer, pressure switch, igniter, gas valve, flame sensor, heat exchanger, and blower, with a table mapping where the sequence stalls to what to suspect', caption: 'The board halts at the failed step — the sequence is the diagnostic map' },
        ],
        tables: [
          {
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/24v-control-alphabet.svg', alt: 'Diagram of the 24VAC control circuit alphabet showing the transformer, thermostat, and a table of terminal functions for R, C, Y, W, G, and O/B, plus meter technique and thermostat placement notes', caption: 'The thermostat just switches — all the intelligence lives in the equipment' },
        ],
        tables: [
          {
