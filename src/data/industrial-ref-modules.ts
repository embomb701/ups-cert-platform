...

  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/ammonia-two-stage-compression.svg', alt: 'Diagram of ammonia thermodynamic properties, its lighter-than-air vapor density and ceiling detector placement, and the two-stage compression chain with a flash intercooler', caption: '7x less refrigerant mass than R-134a, and detectors go near the ceiling — ammonia rises where most HFCs sink.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/ammonia-exposure-toxicology.svg', alt: 'Diagram of the ammonia exposure concentration ladder from odor threshold through olfactory fatigue to IDLH and fatal levels, why ammonia burns tissue, and first aid procedures', caption: 'Olfactory fatigue sets in above 100 ppm — trust the detector over your nose every time.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/evaporative-condenser-heat-rejection.svg', alt: 'Diagram of evaporative condenser heat rejection mechanism, the total heat rejection sizing formula, required water treatment elements, and winterization options', caption: 'Evaporative condensers chase wet-bulb, not dry-bulb — and the whole system is sized for heat rejection, not just the cooling load.' },
        ],
        keyPoints: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/flooded-evaporator-recirculation.svg', alt: 'Diagram of flooded versus DX evaporators, the pumped liquid recirculation overfeed rate, and the four-step hot gas defrost cycle from pump-down through equalization', caption: 'Flooded evaporators pump 2-4x the liquid that actually evaporates, on purpose — and pump-down always comes before hot gas to prevent hydraulic shock.' },
        ],
        keyPoints: [
...

  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/ammonia-fault-diagnosis-tree.svg', alt: 'Diagram of four fault signatures: high discharge pressure causes including non-condensables, high suction pressure causes, low suction pressure causes, and the liquid slugging mechanical emergency signature', caption: 'Four gauge signatures every operator should recognize on sight — frost at the suction flange is never routine.' },
        ],
        keyPoints: [
