  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/pv-iv-curve-diagnostics.svg', alt: 'Diagram of an IV curve showing healthy vs. faulted shapes for current loss, voltage loss, and mismatch steps, alongside panels on shading, soiling, hot spots, and the module-level failure catalog', caption: 'Reading the IV curve: a lower top means current loss, a narrower width means voltage loss, steps mean mismatch.' },
        ],
        keyPoints: [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    slides: [
      ...
      },
      {
        ...
        images: [
          { src: '/diagrams/dc-side-always-live-safety.svg', alt: 'Diagram explaining that PV arrays are always energized when lit, covering DC arc faults and AFCI trips, the dawn-to-noon moisture ground fault pattern, and consolidated DC-side work rules', caption: 'Whenever light hits the array, the DC side is energized — no disconnect changes that fact.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/grid-tie-inverter-architectures.svg', alt: 'Diagram comparing string inverter, microinverter, and DC optimizer architectures, plus panels on anti-islanding and IEEE 1547/UL 1741 utility-governed grid settings', caption: 'String, micro, or optimizer — each trades serviceability against fault granularity; anti-islanding is non-negotiable in all three.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/rapid-shutdown-nec690.svg', alt: 'Diagram of NEC 690.12 rapid shutdown showing the 80-volt-in-30-seconds rule, module-level electronics implementation, the dead-transmitter service fault pattern, and the four-step commissioning test sequence', caption: 'NEC 690.12: rooftop DC collapses to 80V within 30 seconds of initiation — tested at every commissioning and PM.' },
        ],
        keyPoints: [
    ...
    slides: [
      {
        ...
        images: [
          { src: '/diagrams/thermal-runaway-cascade.svg', alt: 'Diagram of the thermal runaway cascade from abuse through exothermic breakdown to propagation, panels on why smothering fails and the four prevention layers, and a field trigger-awareness catalog', caption: 'The self-accelerating, self-oxidizing cascade that writes every BESS safety rule — and the four layers that prevent it.' },
        ],
        keyPoints: [
